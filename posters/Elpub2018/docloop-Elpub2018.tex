...
\node[draw, rectangle, text width=30cm] (src) at ({90 * (4 - 1) + \offset}:\radius) [xshift=15cm] {\pictitle{edit}\\\includegraphics[width=30cm]{src.png}};
\node[draw, rectangle, text width=13cm] (pdf) at ({90 * (3 - 1) + \offset}:\radius) [xshift=10cm]  {\pictitle{publish}\\\includegraphics[width=13cm]{pdf.png}};
\node[draw, rectangle, text width=30cm] (ph)  at ({90 * (2 - 1) + \offset}:\radius) {\pictitle{annotate}\\\includegraphics[width=30cm]{paperhive.png}};
\node[draw, rectangle, text width=15cm] (gh)  at ({90 * (1 - 1) + \offset}:\radius) {\pictitle{manage issues}\\ \includegraphics[width=15cm]{github.png}};
...
\node [left = 6cm of gh,yshift=-3cm] {\includegraphics[width=5cm]{docloop.pdf}};
\end{tikzpicture}
}
